    ...
    <>
      ...
      <main className="flex h-screen w-full pt-[72px]">
        ...
        <div className="hidden lg:block w-1/2 h-full relative overflow-hidden">
          <img alt="High-fashion urban editorial" className="w-full h-full object-cover grayscale brightness-75 contrast-125" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDfeCZ8p1VhO05pzJ-w3jTyp1DCXRdsmP1yudhEuepAM1yEop3Dfo1B4ePAkG64i6x0lwrFCkaRLPecwEcgpl2sw0nkDtzHSviQyiLHcXvrY5TvYJukp2p9bo4oXVVk6GvvqfP0Dpl2I4EHjmdaQ2ln5bzjj1qWAJA_CkqNuGbkJ8K_F3-s2BdV6IwrZWqdt168WmMyDqAG4PVHINbZGHVFErpvRQUlAbdEQFtwCdQVQ_9buk-mc7XkUHzUtf0qFBC5xdLZE6eBULfp" />
        ...
        <div className="w-full lg:w-1/2 h-full flex flex-col bg-surface overflow-y-auto scrollbar-hide px-margin-mobile md:px-margin-desktop">
          <div className="flex-grow flex flex-col justify-center max-w-[480px] mx-auto w-full py-xxl">
            <header className="mb-xl">
              <h1 className="font-display-lg text-display-lg-mobile md:text-headline-md mb-md text-on-surface">Join the Collective.</h1>
            ...
            <div className="mt-xl text-center">
              <p className="font-label-md text-label-md text-on-surface-variant">
                ALREADY HAVE AN ACCOUNT? <a className="text-primary-container hover:underline underline-offset-4 ml-xs" href="#">SIGN IN</a>
              </p>
            </div>
          </div>

          {/* Footer */}
          <footer className="w-full py-xl flex flex-col md:flex-row justify-between items-center gap-gutter border-t border-outline-variant mt-auto">
